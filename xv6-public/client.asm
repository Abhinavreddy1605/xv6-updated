...
_client:     file format elf32-i386
...
int main() {
  ...
  15:	53                   	push   %ebx
  16:	6a 01                	push   $0x1
  18:	e8 4e 03 00 00       	call   36b <recv>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	78 1b                	js     3f <main+0x3f>
        printf(1, "Receiver: No message found for type %d\n", MSG_TYPE);
    } else {
        printf(1, "Message received: %s parent id %d\n", buf,getppid());
  24:	e8 1a 03 00 00       	call   343 <getppid>
  29:	50                   	push   %eax
  2a:	53                   	push   %ebx
  2b:	68 60 07 00 00       	push   $0x760
  30:	6a 01                	push   $0x1
  32:	e8 f9 03 00 00       	call   430 <printf>
  37:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  3a:	e8 64 02 00 00       	call   2a3 <exit>
        printf(1, "Receiver: No message found for type %d\n", MSG_TYPE);
  3f:	50                   	push   %eax
  40:	6a 01                	push   $0x1
  42:	68 38 07 00 00       	push   $0x738
  47:	6a 01                	push   $0x1
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 83 07 00 00       	mov    $0x783,%ebx
