...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     351:	68 90 4d 00 00       	push   $0x4d90
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test ok\n");
     ...
     5d8:	53                   	push   %ebx
     5d9:	68 b4 4d 00 00       	push   $0x4db4
     ...
     5f1:	53                   	push   %ebx
     5f2:	68 d8 4d 00 00       	push   $0x4dd8
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files ok\n");
     ...
     7a3:	50                   	push   %eax
     7a4:	56                   	push   %esi
     7a5:	68 fc 4d 00 00       	push   $0x4dfc
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     84c:	68 1c 4e 00 00       	push   $0x4e1c
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d1:	68 48 4e 00 00       	push   $0x4e48
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ac7:	68 be 40 00 00       	push   $0x40be
     acc:	6a 01                	push   $0x1
     ace:	e8 8d 2f 00 00       	call   3a60 <printf>
  ...
  printf(1, "pipe1 ok\n");
     b55:	5a                   	pop    %edx
     b56:	59                   	pop    %ecx
     b57:	68 e3 40 00 00       	push   $0x40e3
     b5c:	6a 01                	push   $0x1
     b5e:	e8 fd 2e 00 00       	call   3a60 <printf>
     b63:	83 c4 10             	add    $0x10,%esp
     b66:	e9 6b ff ff ff       	jmp    ad6 <pipe1+0xb6>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b6b:	56                   	push   %esi
     b6c:	53                   	push   %ebx
     b6d:	68 cc 40 00 00       	push   $0x40cc
     b72:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 a1 40 00 00       	push   $0x40a1
     b85:	6a 01                	push   $0x1
     b87:	e8 d4 2e 00 00       	call   3a60 <printf>
    exit();
     b8c:	e8 42 2d 00 00       	call   38d3 <exit>
    printf(1, "fork() failed\n");
     b91:	50                   	push   %eax
     b92:	50                   	push   %eax
     b93:	68 ed 40 00 00       	push   $0x40ed
     b98:	6a 01                	push   $0x1
     b9a:	e8 c1 2e 00 00       	call   3a60 <printf>
    exit();
     b9f:	e8 2f 2d 00 00       	call   38d3 <exit>
        printf(1, "pipe1 oops 1\n");
     ba4:	57                   	push   %edi
     ba5:	57                   	push   %edi
     ba6:	68 b0 40 00 00       	push   $0x40b0
     bab:	6a 01                	push   $0x1
     bad:	e8 ae 2e 00 00       	call   3a60 <printf>
        exit();
...
00000bc0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bc9:	68 fc 40 00 00       	push   $0x40fc
     bce:	6a 01                	push   $0x1
     bd0:	e8 8b 2e 00 00       	call   3a60 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c28:	6a 01                	push   $0x1
     c2a:	68 c1 46 00 00       	push   $0x46c1
  ...
  printf(1, "kill... ");
     c8b:	58                   	pop    %eax
     c8c:	5a                   	pop    %edx
     c8d:	68 2d 41 00 00       	push   $0x412d
     c92:	6a 01                	push   $0x1
     c94:	e8 c7 2d 00 00       	call   3a60 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     cb1:	59                   	pop    %ecx
     cb2:	5b                   	pop    %ebx
     cb3:	68 36 41 00 00       	push   $0x4136
     cb8:	6a 01                	push   $0x1
     cba:	e8 a1 2d 00 00       	call   3a60 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     cce:	5e                   	pop    %esi
     ccf:	5f                   	pop    %edi
     cd0:	68 3f 41 00 00       	push   $0x413f
     cd5:	6a 01                	push   $0x1
     cd7:	e8 84 2d 00 00       	call   3a60 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cea:	68 1a 41 00 00       	push   $0x411a
     cef:	6a 01                	push   $0x1
     cf1:	e8 6a 2d 00 00       	call   3a60 <printf>
     cf6:	83 c4 10             	add    $0x10,%esp
     cf9:	eb e4                	jmp    cdf <preempt+0x11f>
      printf(1, "preempt write error");
     cfb:	83 ec 08             	sub    $0x8,%esp
     cfe:	68 06 41 00 00       	push   $0x4106
     d03:	6a 01                	push   $0x1
     d05:	e8 56 2d 00 00       	call   3a60 <printf>
...
00000d20 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d4e:	68 a9 4c 00 00       	push   $0x4ca9
     d53:	6a 01                	push   $0x1
     d55:	e8 06 2d 00 00       	call   3a60 <printf>
      return;
     ...
     d6b:	68 4b 41 00 00       	push   $0x414b
     d70:	6a 01                	push   $0x1
     d72:	e8 e9 2c 00 00       	call   3a60 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d84:	68 5b 41 00 00       	push   $0x415b
     d89:	6a 01                	push   $0x1
     d8b:	e8 d0 2c 00 00       	call   3a60 <printf>
...
00000da0 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     daa:	68 68 41 00 00       	push   $0x4168
     daf:	6a 01                	push   $0x1
     db1:	e8 aa 2c 00 00       	call   3a60 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ddc:	e8 9f 2e 00 00       	call   3c80 <malloc>
    ...
    printf(1, "mem ok\n");
     e21:	58                   	pop    %eax
     e22:	5a                   	pop    %edx
     e23:	68 8c 41 00 00       	push   $0x418c
     e28:	6a 01                	push   $0x1
     e2a:	e8 31 2c 00 00       	call   3a60 <printf>
    exit();
     e2f:	e8 9f 2a 00 00       	call   38d3 <exit>
     e34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e38:	83 ec 08             	sub    $0x8,%esp
     e3b:	68 72 41 00 00       	push   $0x4172
     e40:	6a 01                	push   $0x1
     e42:	e8 19 2c 00 00       	call   3a60 <printf>
      kill(ppid);
...
00000e70 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e79:	68 94 41 00 00       	push   $0x4194
     e7e:	6a 01                	push   $0x1
     e80:	e8 db 2b 00 00       	call   3a60 <printf>
  unlink("sharedfd");
     e85:	c7 04 24 a3 41 00 00 	movl   $0x41a3,(%esp)
     e8c:	e8 92 2a 00 00       	call   3923 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e91:	5b                   	pop    %ebx
     e92:	5e                   	pop    %esi
     e93:	68 02 02 00 00       	push   $0x202
     e98:	68 a3 41 00 00       	push   $0x41a3
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     efc:	68 9c 4e 00 00       	push   $0x4e9c
     f01:	6a 01                	push   $0x1
     f03:	e8 58 2b 00 00       	call   3a60 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f2a:	5a                   	pop    %edx
     f2b:	6a 00                	push   $0x0
     f2d:	68 a3 41 00 00       	push   $0x41a3
  ...
  unlink("sharedfd");
     f9b:	c7 04 24 a3 41 00 00 	movl   $0x41a3,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fc0:	68 ac 41 00 00       	push   $0x41ac
     fc5:	6a 01                	push   $0x1
     fc7:	e8 94 2a 00 00       	call   3a60 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fda:	68 70 4e 00 00       	push   $0x4e70
     fdf:	6a 01                	push   $0x1
     fe1:	e8 7a 2a 00 00       	call   3a60 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     ff4:	68 bc 4e 00 00       	push   $0x4ebc
     ff9:	6a 01                	push   $0x1
     ffb:	e8 60 2a 00 00       	call   3a60 <printf>
    return;
    ...
    1010:	53                   	push   %ebx
    1011:	52                   	push   %edx
    1012:	68 b9 41 00 00       	push   $0x41b9
    1017:	6a 01                	push   $0x1
    1019:	e8 42 2a 00 00       	call   3a60 <printf>
    exit();
    ...
    1036:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    103b:	c7 45 d8 ce 41 00 00 	movl   $0x41ce,-0x28(%ebp)
    1042:	c7 45 dc 17 43 00 00 	movl   $0x4317,-0x24(%ebp)
    1049:	c7 45 e0 1b 43 00 00 	movl   $0x431b,-0x20(%ebp)
    1050:	c7 45 e4 d1 41 00 00 	movl   $0x41d1,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1057:	68 d4 41 00 00       	push   $0x41d4
    105c:	6a 01                	push   $0x1
    105e:	e8 fd 29 00 00       	call   3a60 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10d8:	68 80 85 00 00       	push   $0x8580
    ...
    10f2:	0f be 8a 80 85 00 00 	movsbl 0x8580(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    114e:	68 12 42 00 00       	push   $0x4212
    1153:	6a 01                	push   $0x1
    1155:	e8 06 29 00 00       	call   3a60 <printf>
}
    ...
    1168:	68 f5 41 00 00       	push   $0x41f5
    116d:	6a 01                	push   $0x1
    116f:	e8 ec 28 00 00       	call   3a60 <printf>
          exit();
    ...
    11a1:	68 80 85 00 00       	push   $0x8580
    ...
    11b6:	68 80 85 00 00       	push   $0x8580
    11bb:	56                   	push   %esi
    ...
    11d5:	51                   	push   %ecx
    11d6:	51                   	push   %ecx
    11d7:	68 6f 44 00 00       	push   $0x446f
    11dc:	6a 01                	push   $0x1
    11de:	e8 7d 28 00 00       	call   3a60 <printf>
        exit();
    ...
    11f3:	68 a9 4c 00 00       	push   $0x4ca9
    11f8:	6a 01                	push   $0x1
    11fa:	e8 61 28 00 00       	call   3a60 <printf>
      exit();
    11ff:	e8 cf 26 00 00       	call   38d3 <exit>
      printf(1, "wrong length %d\n", total);
    1204:	50                   	push   %eax
    1205:	57                   	push   %edi
    1206:	68 01 42 00 00       	push   $0x4201
    120b:	6a 01                	push   $0x1
    120d:	e8 4e 28 00 00       	call   3a60 <printf>
      exit();
    1212:	e8 bc 26 00 00       	call   38d3 <exit>
          printf(1, "write failed %d\n", n);
    1217:	52                   	push   %edx
    1218:	50                   	push   %eax
    1219:	68 e4 41 00 00       	push   $0x41e4
    121e:	6a 01                	push   $0x1
    1220:	e8 3b 28 00 00       	call   3a60 <printf>
          exit();
    ...
    1235:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "createdelete test\n");
    123b:	68 20 42 00 00       	push   $0x4220
    1240:	6a 01                	push   $0x1
    1242:	e8 19 28 00 00       	call   3a60 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    1344:	50                   	push   %eax
    1345:	56                   	push   %esi
    1346:	68 0c 4f 00 00       	push   $0x4f0c
    134b:	6a 01                	push   $0x1
    ...
    13d9:	52                   	push   %edx
    13da:	52                   	push   %edx
    13db:	68 21 3e 00 00       	push   $0x3e21
    13e0:	6a 01                	push   $0x1
    13e2:	e8 79 26 00 00       	call   3a60 <printf>
            exit();
    ...
    13f3:	56                   	push   %esi
    13f4:	68 e8 4e 00 00       	push   $0x4ee8
    13f9:	6a 01                	push   $0x1
    ...
    1408:	68 a9 4c 00 00       	push   $0x4ca9
    140d:	6a 01                	push   $0x1
    ...
    141c:	68 6f 44 00 00       	push   $0x446f
    1421:	6a 01                	push   $0x1
...
00001430 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    143d:	6a 01                	push   $0x1
    143f:	e8 1c 26 00 00       	call   3a60 <printf>
  ...
  printf(1, "unlinkread ok\n");
    ...
    1535:	6a 01                	push   $0x1
    1537:	e8 24 25 00 00       	call   3a60 <printf>
}
    ...
    154d:	6a 01                	push   $0x1
    154f:	e8 0c 25 00 00       	call   3a60 <printf>
    exit();
    ...
    1560:	6a 01                	push   $0x1
    1562:	e8 f9 24 00 00       	call   3a60 <printf>
    exit();
    ...
    1573:	6a 01                	push   $0x1
    1575:	e8 e6 24 00 00       	call   3a60 <printf>
    exit();
    ...
    1586:	6a 01                	push   $0x1
    1588:	e8 d3 24 00 00       	call   3a60 <printf>
    exit();
    ...
    1599:	6a 01                	push   $0x1
    159b:	e8 c0 24 00 00       	call   3a60 <printf>
    exit();
...
000015c0 <linktest>:
{
  ...
  printf(1, "linktest ok\n");
    ...
    1716:	6a 01                	push   $0x1
    1718:	e8 43 23 00 00       	call   3a60 <printf>
}
    ...
    172c:	6a 01                	push   $0x1
    172e:	e8 2d 23 00 00       	call   3a60 <printf>
    exit();
    ...
    173f:	6a 01                	push   $0x1
    1741:	e8 1a 23 00 00       	call   3a60 <printf>
    exit();
    1746:	e8 88 21 00 00       	call   38d3 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 54 4f 00 00       	push   $0x4f54
    1752:	6a 01                	push   $0x1
    1754:	e8 07 23 00 00       	call   3a60 <printf>
    exit();
    ...
    1765:	6a 01                	push   $0x1
    1767:	e8 f4 22 00 00       	call   3a60 <printf>
    exit();
    ...
    1778:	6a 01                	push   $0x1
    177a:	e8 e1 22 00 00       	call   3a60 <printf>
    exit();
    ...
    178b:	6a 01                	push   $0x1
    178d:	e8 ce 22 00 00       	call   3a60 <printf>
    exit();
    1792:	e8 3c 21 00 00       	call   38d3 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 2c 4f 00 00       	push   $0x4f2c
    179e:	6a 01                	push   $0x1
    17a0:	e8 bb 22 00 00       	call   3a60 <printf>
    exit();
    ...
    17b1:	6a 01                	push   $0x1
    17b3:	e8 a8 22 00 00       	call   3a60 <printf>
    exit();
    ...
    17c4:	6a 01                	push   $0x1
    17c6:	e8 95 22 00 00       	call   3a60 <printf>
    exit();
    ...
    17d5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17de:	68 c1 43 00 00       	push   $0x43c1
    17e3:	6a 01                	push   $0x1
    17e5:	e8 76 22 00 00       	call   3a60 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    188c:	53                   	push   %ebx
    188d:	68 d4 43 00 00       	push   $0x43d4
    1892:	6a 01                	push   $0x1
    1894:	e8 c7 21 00 00       	call   3a60 <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    18a3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18a6:	53                   	push   %ebx
    18a7:	68 d1 43 00 00       	push   $0x43d1
  ...
  fd = open(".", 0);
    ...
    18d3:	5f                   	pop    %edi
    18d4:	6a 00                	push   $0x0
    18d6:	68 de 45 00 00       	push   $0x45de
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1943:	53                   	push   %ebx
    1944:	68 d1 43 00 00       	push   $0x43d1
  ...
  printf(1, "concreate ok\n");
    ...
    1a4b:	68 26 44 00 00       	push   $0x4426
    1a50:	6a 01                	push   $0x1
    1a52:	e8 09 20 00 00       	call   3a60 <printf>
}
    ...
    1a62:	68 a9 4c 00 00       	push   $0x4ca9
    1a67:	6a 01                	push   $0x1
    1a69:	e8 f2 1f 00 00       	call   3a60 <printf>
      exit();
    ...
    1a8a:	50                   	push   %eax
    1a8b:	68 f0 43 00 00       	push   $0x43f0
    1a90:	6a 01                	push   $0x1
    1a92:	e8 c9 1f 00 00       	call   3a60 <printf>
        exit();
    1a97:	e8 37 1e 00 00       	call   38d3 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a9c:	51                   	push   %ecx
    1a9d:	51                   	push   %ecx
    1a9e:	68 78 4f 00 00       	push   $0x4f78
    1aa3:	6a 01                	push   $0x1
    1aa5:	e8 b6 1f 00 00       	call   3a60 <printf>
    exit();
    ...
    1ab5:	50                   	push   %eax
    1ab6:	68 09 44 00 00       	push   $0x4409
    1abb:	6a 01                	push   $0x1
    1abd:	e8 9e 1f 00 00       	call   3a60 <printf>
        exit();
...
00001ad0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ade:	6a 01                	push   $0x1
    1ae0:	e8 7b 1f 00 00       	call   3a60 <printf>
  unlink("x");
  ...
  for(i = 0; i < 100; i++){
    ...
    1b61:	68 c1 46 00 00       	push   $0x46c1
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b8a:	68 49 44 00 00       	push   $0x4449
    1b8f:	6a 01                	push   $0x1
    1b91:	e8 ca 1e 00 00       	call   3a60 <printf>
}
    ...
    1bc1:	6a 01                	push   $0x1
    1bc3:	e8 98 1e 00 00       	call   3a60 <printf>
    exit();
...
00001be0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    ...
    1bee:	6a 01                	push   $0x1
    1bf0:	e8 6b 1e 00 00       	call   3a60 <printf>
  unlink("bd");
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c51:	57                   	push   %edi
    1c52:	68 65 44 00 00       	push   $0x4465
  ...
  printf(1, "bigdir ok\n");
    ...
    1cc1:	6a 01                	push   $0x1
    1cc3:	e8 98 1d 00 00       	call   3a60 <printf>
    ...
    1cdb:	6a 01                	push   $0x1
    1cdd:	e8 7e 1d 00 00       	call   3a60 <printf>
      exit();
    ...
    1cef:	6a 01                	push   $0x1
    1cf1:	e8 6a 1d 00 00       	call   3a60 <printf>
      exit();
    ...
    1d02:	6a 01                	push   $0x1
    1d04:	e8 57 1d 00 00       	call   3a60 <printf>
    exit();
...
00001d10 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    ...
    1d1c:	6a 01                	push   $0x1
    1d1e:	e8 3d 1d 00 00       	call   3a60 <printf>
  unlink("ff");
  ...
  printf(1, "subdir ok\n");
    ...
    2148:	6a 01                	push   $0x1
    214a:	e8 11 19 00 00       	call   3a60 <printf>
}
    ...
    215e:	6a 01                	push   $0x1
    2160:	e8 fb 18 00 00       	call   3a60 <printf>
    exit();
    ...
    2171:	6a 01                	push   $0x1
    2173:	e8 e8 18 00 00       	call   3a60 <printf>
    exit();
    ...
    2184:	6a 01                	push   $0x1
    2186:	e8 d5 18 00 00       	call   3a60 <printf>
    exit();
    ...
    2197:	6a 01                	push   $0x1
    2199:	e8 c2 18 00 00       	call   3a60 <printf>
    exit();
    219e:	e8 30 17 00 00       	call   38d3 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21a3:	53                   	push   %ebx
    21a4:	53                   	push   %ebx
    21a5:	68 1c 50 00 00       	push   $0x501c
    21aa:	6a 01                	push   $0x1
    21ac:	e8 af 18 00 00       	call   3a60 <printf>
    exit();
    ...
    21bd:	6a 01                	push   $0x1
    21bf:	e8 9c 18 00 00       	call   3a60 <printf>
    exit();
    21c4:	e8 0a 17 00 00       	call   38d3 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21c9:	53                   	push   %ebx
    21ca:	53                   	push   %ebx
    21cb:	68 8c 50 00 00       	push   $0x508c
    21d0:	6a 01                	push   $0x1
    21d2:	e8 89 18 00 00       	call   3a60 <printf>
    exit();
    ...
    21e3:	6a 01                	push   $0x1
    21e5:	e8 76 18 00 00       	call   3a60 <printf>
    exit();
    ...
    21f6:	6a 01                	push   $0x1
    21f8:	e8 63 18 00 00       	call   3a60 <printf>
    exit();
    ...
    2209:	6a 01                	push   $0x1
    220b:	e8 50 18 00 00       	call   3a60 <printf>
    exit();
    2210:	e8 be 16 00 00       	call   38d3 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2215:	52                   	push   %edx
    2216:	52                   	push   %edx
    2217:	68 d4 4f 00 00       	push   $0x4fd4
    221c:	6a 01                	push   $0x1
    221e:	e8 3d 18 00 00       	call   3a60 <printf>
    exit();
    2223:	e8 ab 16 00 00       	call   38d3 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2228:	50                   	push   %eax
    2229:	50                   	push   %eax
    222a:	68 68 50 00 00       	push   $0x5068
    222f:	6a 01                	push   $0x1
    2231:	e8 2a 18 00 00       	call   3a60 <printf>
    exit();
    2236:	e8 98 16 00 00       	call   38d3 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 44 50 00 00       	push   $0x5044
    2242:	6a 01                	push   $0x1
    2244:	e8 17 18 00 00       	call   3a60 <printf>
    exit();
    ...
    2255:	6a 01                	push   $0x1
    2257:	e8 04 18 00 00       	call   3a60 <printf>
    exit();
    ...
    2268:	6a 01                	push   $0x1
    226a:	e8 f1 17 00 00       	call   3a60 <printf>
    exit();
    ...
    227b:	6a 01                	push   $0x1
    227d:	e8 de 17 00 00       	call   3a60 <printf>
    exit();
    ...
    228e:	6a 01                	push   $0x1
    2290:	e8 cb 17 00 00       	call   3a60 <printf>
    exit();
    ...
    22a1:	6a 01                	push   $0x1
    22a3:	e8 b8 17 00 00       	call   3a60 <printf>
    exit();
    22a8:	e8 26 16 00 00       	call   38d3 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 f8 4f 00 00       	push   $0x4ff8
    22b4:	6a 01                	push   $0x1
    22b6:	e8 a5 17 00 00       	call   3a60 <printf>
    exit();
    ...
    22c7:	6a 01                	push   $0x1
    22c9:	e8 92 17 00 00       	call   3a60 <printf>
    exit();
    22ce:	e8 00 16 00 00       	call   38d3 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 ac 4f 00 00       	push   $0x4fac
    22da:	6a 01                	push   $0x1
    22dc:	e8 7f 17 00 00       	call   3a60 <printf>
    exit();
    ...
    22ed:	6a 01                	push   $0x1
    22ef:	e8 6c 17 00 00       	call   3a60 <printf>
    exit();
    ...
    2300:	6a 01                	push   $0x1
    2302:	e8 59 17 00 00       	call   3a60 <printf>
    exit();
    ...
    2313:	6a 01                	push   $0x1
    2315:	e8 46 17 00 00       	call   3a60 <printf>
    exit();
    ...
    2326:	6a 01                	push   $0x1
    2328:	e8 33 17 00 00       	call   3a60 <printf>
    exit();
    232d:	e8 a1 15 00 00       	call   38d3 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 b0 50 00 00       	push   $0x50b0
    2339:	6a 01                	push   $0x1
    233b:	e8 20 17 00 00       	call   3a60 <printf>
    exit();
    ...
    234c:	6a 01                	push   $0x1
    234e:	e8 0d 17 00 00       	call   3a60 <printf>
    exit();
    ...
    235f:	6a 01                	push   $0x1
    2361:	e8 fa 16 00 00       	call   3a60 <printf>
    exit();
    ...
    2372:	6a 01                	push   $0x1
    2374:	e8 e7 16 00 00       	call   3a60 <printf>
    exit();
    ...
    2385:	6a 01                	push   $0x1
    2387:	e8 d4 16 00 00       	call   3a60 <printf>
    exit();
    ...
    2398:	6a 01                	push   $0x1
    239a:	e8 c1 16 00 00       	call   3a60 <printf>
    exit();
    ...
    23ab:	6a 01                	push   $0x1
    23ad:	e8 ae 16 00 00       	call   3a60 <printf>
    exit();
    ...
    23be:	6a 01                	push   $0x1
    23c0:	e8 9b 16 00 00       	call   3a60 <printf>
    exit();
    ...
    23d1:	6a 01                	push   $0x1
    23d3:	e8 88 16 00 00       	call   3a60 <printf>
    exit();
    ...
    23e4:	6a 01                	push   $0x1
    23e6:	e8 75 16 00 00       	call   3a60 <printf>
    exit();
...
000023f0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2402:	6a 01                	push   $0x1
    2404:	e8 57 16 00 00       	call   3a60 <printf>
  unlink("bigwrite");
  ...
  printf(1, "bigwrite ok\n");
    ...
    2495:	6a 01                	push   $0x1
    2497:	e8 c4 15 00 00       	call   3a60 <printf>
}
    ...
    24ad:	6a 01                	push   $0x1
    24af:	e8 ac 15 00 00       	call   3a60 <printf>
        exit();
    ...
    24c1:	6a 01                	push   $0x1
    24c3:	e8 98 15 00 00       	call   3a60 <printf>
      exit();
...
000024d0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    ...
    24de:	6a 01                	push   $0x1
    24e0:	e8 7b 15 00 00       	call   3a60 <printf>
  unlink("bigfile");
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 d0 50 00 00       	push   $0x50d0
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 20 51 00 00       	push   $0x5120
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 90 51 00 00       	push   $0x5190
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    273b:	68 2c 52 00 00       	push   $0x522c
  ...
  printf(1, "fourteen ok\n");
    ...
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 4c 52 00 00       	push   $0x524c
    277a:	6a 01                	push   $0x1
    ...
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 fc 51 00 00       	push   $0x51fc
    278d:	6a 01                	push   $0x1
    ...
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 c0 51 00 00       	push   $0x51c0
    27a0:	6a 01                	push   $0x1
    ...
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 50 51 00 00       	push   $0x5150
    27b3:	6a 01                	push   $0x1
    ...
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 f0 50 00 00       	push   $0x50f0
    27c6:	6a 01                	push   $0x1
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file OK\n");
    ...
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 a0 52 00 00       	push   $0x52a0
    2aff:	6a 01                	push   $0x1
    ...
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 80 52 00 00       	push   $0x5280
    2b25:	6a 01                	push   $0x1
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test OK\n");
    ...
    2cf4:	68 23 4b 00 00       	push   $0x4b23
    2cf9:	6a 01                	push   $0x1
    ...
    2d05:	52                   	push   %edx
    2d06:	52                   	push   %edx
    2d07:	68 37 4b 00 00       	push   $0x4b37
    2d0c:	6a 01                	push   $0x1
    ...
    2d18:	50                   	push   %eax
    2d19:	50                   	push   %eax
    2d1a:	68 c0 52 00 00       	push   $0x52c0
    2d1f:	6a 01                	push   $0x1
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 48 5e 00 00    	push   0x5e48
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fa5:	68 00 4c 00 00       	push   $0x4c00
    2faa:	ff 35 48 5e 00 00    	push   0x5e48
    2fb0:	e8 ab 0a 00 00       	call   3a60 <printf>
}
    ...
    2fde:	6a 01                	push   $0x1
    2fe0:	68 c1 46 00 00       	push   $0x46c1
    ...
    3027:	53                   	push   %ebx
    3028:	56                   	push   %esi
    3029:	68 63 4b 00 00       	push   $0x4b63
    302e:	ff 35 48 5e 00 00    	push   0x5e48
    3034:	e8 27 0a 00 00       	call   3a60 <printf>
      exit();
    3039:	83 c4 20             	add    $0x20,%esp
    303c:	e8 92 08 00 00       	call   38d3 <exit>
      printf(stdout, "fork failed\n");
    3041:	83 ec 08             	sub    $0x8,%esp
    3044:	68 a9 4c 00 00       	push   $0x4ca9
    3049:	ff 35 48 5e 00 00    	push   0x5e48
    304f:	e8 0c 0a 00 00       	call   3a60 <printf>
      exit();
    ...
    305c:	50                   	push   %eax
    305d:	53                   	push   %ebx
    305e:	68 cc 4b 00 00       	push   $0x4bcc
    3063:	ff 35 48 5e 00 00    	push   0x5e48
    ...
    307b:	50                   	push   %eax
    307c:	53                   	push   %ebx
    307d:	68 b4 53 00 00       	push   $0x53b4
    3082:	ff 35 48 5e 00 00    	push   0x5e48
    ...
    3092:	56                   	push   %esi
    3093:	56                   	push   %esi
    3094:	68 e4 52 00 00       	push   $0x52e4
    3099:	ff 35 48 5e 00 00    	push   0x5e48
    309f:	e8 bc 09 00 00       	call   3a60 <printf>
    exit();
    30a4:	e8 2a 08 00 00       	call   38d3 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30a9:	50                   	push   %eax
    30aa:	50                   	push   %eax
    30ab:	68 7e 4b 00 00       	push   $0x4b7e
    30b0:	ff 35 48 5e 00 00    	push   0x5e48
    30b6:	e8 a5 09 00 00       	call   3a60 <printf>
    exit();
    30bb:	e8 13 08 00 00       	call   38d3 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30c0:	51                   	push   %ecx
    30c1:	51                   	push   %ecx
    30c2:	68 84 53 00 00       	push   $0x5384
    30c7:	ff 35 48 5e 00 00    	push   0x5e48
    30cd:	e8 8e 09 00 00       	call   3a60 <printf>
    exit();
    30d2:	e8 fc 07 00 00       	call   38d3 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30d7:	50                   	push   %eax
    30d8:	50                   	push   %eax
    30d9:	68 e5 4b 00 00       	push   $0x4be5
    30de:	ff 35 48 5e 00 00    	push   0x5e48
    30e4:	e8 77 09 00 00       	call   3a60 <printf>
    exit();
    30e9:	e8 e5 07 00 00       	call   38d3 <exit>
    printf(1, "pipe() failed\n");
    30ee:	52                   	push   %edx
    30ef:	52                   	push   %edx
    30f0:	68 a1 40 00 00       	push   $0x40a1
    30f5:	6a 01                	push   $0x1
    30f7:	e8 64 09 00 00       	call   3a60 <printf>
    exit();
    ...
    3106:	57                   	push   %edi
    3107:	57                   	push   %edi
    3108:	68 95 4b 00 00       	push   $0x4b95
    310d:	ff 35 48 5e 00 00    	push   0x5e48
    3113:	e8 48 09 00 00       	call   3a60 <printf>
    exit();
    3118:	e8 b6 07 00 00       	call   38d3 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    311d:	56                   	push   %esi
    311e:	53                   	push   %ebx
    311f:	68 5c 53 00 00       	push   $0x535c
    3124:	ff 35 48 5e 00 00    	push   0x5e48
    312a:	e8 31 09 00 00       	call   3a60 <printf>
    exit();
    312f:	e8 9f 07 00 00       	call   38d3 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3134:	50                   	push   %eax
    3135:	53                   	push   %ebx
    3136:	68 24 53 00 00       	push   $0x5324
    313b:	ff 35 48 5e 00 00    	push   0x5e48
    ...
    314b:	53                   	push   %ebx
    314c:	53                   	push   %ebx
    314d:	68 b1 4b 00 00       	push   $0x4bb1
    3152:	ff 35 48 5e 00 00    	push   0x5e48
    3158:	e8 03 09 00 00       	call   3a60 <printf>
    exit();
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318a:	68 0e 4c 00 00       	push   $0x4c0e
    318f:	ff 35 48 5e 00 00    	push   0x5e48
    ...
    31cf:	5a                   	pop    %edx
    31d0:	56                   	push   %esi
    31d1:	68 1d 4c 00 00       	push   $0x4c1d
  ...
  printf(stdout, "validate ok\n");
    ...
    31f4:	68 41 4c 00 00       	push   $0x4c41
    31f9:	ff 35 48 5e 00 00    	push   0x5e48
    ...
    3216:	68 28 4c 00 00       	push   $0x4c28
    321b:	ff 35 48 5e 00 00    	push   0x5e48
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3236:	68 4e 4c 00 00       	push   $0x4c4e
    323b:	ff 35 48 5e 00 00    	push   0x5e48
  ...
  printf(stdout, "bss test ok\n");
    ...
    3266:	68 69 4c 00 00       	push   $0x4c69
    326b:	ff 35 48 5e 00 00    	push   0x5e48
    ...
    327e:	68 58 4c 00 00       	push   $0x4c58
    3283:	ff 35 48 5e 00 00    	push   0x5e48
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32a6:	68 76 4c 00 00       	push   $0x4c76
  ...
  fd = open("bigarg-ok", 0);
    ...
    32ca:	6a 00                	push   $0x0
    32cc:	68 76 4c 00 00       	push   $0x4c76
  ...
  unlink("bigarg-ok");
    32ea:	c7 04 24 76 4c 00 00 	movl   $0x4c76,(%esp)
    ...
    32fb:	c7 04 85 80 a5 00 00 	movl   $0x53d8,0xa580(,%eax,4)
    3302:	d8 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3306:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 80 a5 00 00 	movl   $0x53d8,0xa580(,%eax,4)
    3312:	d8 53 00 00 
    3316:	c7 04 85 84 a5 00 00 	movl   $0x53d8,0xa584(,%eax,4)
    331d:	d8 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    printf(stdout, "bigarg test\n");
    332c:	50                   	push   %eax
    332d:	68 80 4c 00 00       	push   $0x4c80
    3332:	ff 35 48 5e 00 00    	push   0x5e48
    args[MAXARG-1] = 0;
    3338:	89 0d fc a5 00 00    	mov    %ecx,0xa5fc
    printf(stdout, "bigarg test\n");
    333e:	e8 1d 07 00 00       	call   3a60 <printf>
    exec("echo", args);
    3343:	58                   	pop    %eax
    3344:	5a                   	pop    %edx
    3345:	68 80 a5 00 00       	push   $0xa580
    334a:	68 4d 3e 00 00       	push   $0x3e4d
    334f:	e8 b7 05 00 00       	call   390b <exec>
    printf(stdout, "bigarg test ok\n");
    3354:	59                   	pop    %ecx
    3355:	58                   	pop    %eax
    3356:	68 8d 4c 00 00       	push   $0x4c8d
    335b:	ff 35 48 5e 00 00    	push   0x5e48
    3361:	e8 fa 06 00 00       	call   3a60 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3366:	58                   	pop    %eax
    3367:	5a                   	pop    %edx
    3368:	68 00 02 00 00       	push   $0x200
    336d:	68 76 4c 00 00       	push   $0x4c76
    ...
    3384:	50                   	push   %eax
    3385:	50                   	push   %eax
    3386:	68 b6 4c 00 00       	push   $0x4cb6
    338b:	ff 35 48 5e 00 00    	push   0x5e48
    3391:	e8 ca 06 00 00       	call   3a60 <printf>
    exit();
    3396:	e8 38 05 00 00       	call   38d3 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    339b:	52                   	push   %edx
    339c:	52                   	push   %edx
    339d:	68 9d 4c 00 00       	push   $0x4c9d
    33a2:	ff 35 48 5e 00 00    	push   0x5e48
    33a8:	e8 b3 06 00 00       	call   3a60 <printf>
    exit();
    ...
    33c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33cb:	68 cb 4c 00 00       	push   $0x4ccb
    33d0:	6a 01                	push   $0x1
    33d2:	e8 89 06 00 00       	call   3a60 <printf>
    ...
    3451:	50                   	push   %eax
    3452:	68 d8 4c 00 00       	push   $0x4cd8
    3457:	6a 01                	push   $0x1
    3459:	e8 02 06 00 00       	call   3a60 <printf>
    ...
    348a:	68 80 85 00 00       	push   $0x8580
    348f:	57                   	push   %edi
    ...
    34a2:	53                   	push   %ebx
    34a3:	68 f4 4c 00 00       	push   $0x4cf4
    34a8:	6a 01                	push   $0x1
    34aa:	e8 b1 05 00 00       	call   3a60 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34cc:	50                   	push   %eax
    34cd:	68 e4 4c 00 00       	push   $0x4ce4
    34d2:	6a 01                	push   $0x1
    34d4:	e8 87 05 00 00       	call   3a60 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    356c:	68 04 4d 00 00       	push   $0x4d04
    3571:	6a 01                	push   $0x1
    3573:	e8 e8 04 00 00       	call   3a60 <printf>
}
...
00003590 <uio>:
{
  ...
  printf(1, "uio test\n");
    3596:	68 1a 4d 00 00       	push   $0x4d1a
    359b:	6a 01                	push   $0x1
    359d:	e8 be 04 00 00       	call   3a60 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    35b8:	68 24 4d 00 00       	push   $0x4d24
    35bd:	6a 01                	push   $0x1
    35bf:	e8 9c 04 00 00       	call   3a60 <printf>
}
    ...
    35da:	52                   	push   %edx
    35db:	52                   	push   %edx
    35dc:	68 b8 54 00 00       	push   $0x54b8
    35e1:	6a 01                	push   $0x1
    35e3:	e8 78 04 00 00       	call   3a60 <printf>
    exit();
    35e8:	e8 e6 02 00 00       	call   38d3 <exit>
    printf (1, "fork failed\n");
    35ed:	50                   	push   %eax
    35ee:	50                   	push   %eax
    35ef:	68 a9 4c 00 00       	push   $0x4ca9
    35f4:	6a 01                	push   $0x1
    35f6:	e8 65 04 00 00       	call   3a60 <printf>
    exit();
...
00003600 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3607:	6a 00                	push   $0x0
    3609:	68 33 4d 00 00       	push   $0x4d33
  ...
  printf(1, "arg test passed\n");
    363d:	58                   	pop    %eax
    363e:	5a                   	pop    %edx
    363f:	68 45 4d 00 00       	push   $0x4d45
    3644:	6a 01                	push   $0x1
    3646:	e8 15 04 00 00       	call   3a60 <printf>
}
    ...
    3653:	51                   	push   %ecx
    3654:	51                   	push   %ecx
    3655:	68 38 4d 00 00       	push   $0x4d38
    365a:	6a 02                	push   $0x2
    365c:	e8 ff 03 00 00       	call   3a60 <printf>
    exit();
...
00003670 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3670:	69 05 44 5e 00 00 0d 	imul   $0x19660d,0x5e44,%eax
    3677:	66 19 00 
    367a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    367f:	a3 44 5e 00 00       	mov    %eax,0x5e44
}
    3684:	c3                   	ret
    ...
    39c8:	89 d1                	mov    %edx,%ecx
{
    ...
    39cd:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    39d0:	85 d2                	test   %edx,%edx
    39d2:	0f 89 80 00 00 00    	jns    3a58 <printint+0x98>
    39d8:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    39dc:	74 7a                	je     3a58 <printint+0x98>
    x = -xx;
    39de:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    39e5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  ...
  do{
    ...
    39f4:	89 f7                	mov    %esi,%edi
    39f6:	f7 f3                	div    %ebx
    39f8:	8d 76 01             	lea    0x1(%esi),%esi
    39fb:	0f b6 92 60 55 00 00 	movzbl 0x5560(%edx),%edx
    3a02:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    3a06:	89 ca                	mov    %ecx,%edx
    3a08:	89 c1                	mov    %eax,%ecx
    3a0a:	39 da                	cmp    %ebx,%edx
    3a0c:	73 e2                	jae    39f0 <printint+0x30>
  if(neg)
    3a0e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    3a11:	85 c0                	test   %eax,%eax
    3a13:	74 07                	je     3a1c <printint+0x5c>
    buf[i++] = '-';
    3a15:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    3a1a:	89 f7                	mov    %esi,%edi
    3a1c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    3a1f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    3a22:	01 df                	add    %ebx,%edi
    3a24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    3a28:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    3a2b:	83 ec 04             	sub    $0x4,%esp
    3a2e:	88 45 d7             	mov    %al,-0x29(%ebp)
    3a31:	8d 45 d7             	lea    -0x29(%ebp),%eax
    3a34:	6a 01                	push   $0x1
    3a36:	50                   	push   %eax
    3a37:	56                   	push   %esi
    3a38:	e8 b6 fe ff ff       	call   38f3 <write>
  while(--i >= 0)
    3a3d:	89 f8                	mov    %edi,%eax
    3a3f:	83 c4 10             	add    $0x10,%esp
    3a42:	83 ef 01             	sub    $0x1,%edi
    3a45:	39 c3                	cmp    %eax,%ebx
    3a47:	75 df                	jne    3a28 <printint+0x68>
}
    3a49:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3a4c:	5b                   	pop    %ebx
    3a4d:	5e                   	pop    %esi
    3a4e:	5f                   	pop    %edi
    3a4f:	5d                   	pop    %ebp
  ...
  neg = 0;
    ...
    3a5a:	eb 89                	jmp    39e5 <printint+0x25>
...
{
    3a6c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    3a6f:	0f b6 1e             	movzbl (%esi),%ebx
    3a72:	83 c6 01             	add    $0x1,%esi
    3a75:	84 db                	test   %bl,%bl
    3a77:	74 67                	je     3ae0 <printf+0x80>
    3a79:	8d 4d 10             	lea    0x10(%ebp),%ecx
    3a7c:	31 d2                	xor    %edx,%edx
    3a7e:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    3a81:	eb 34                	jmp    3ab7 <printf+0x57>
    3a83:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    3a88:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3a8b:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    3a90:	83 f8 25             	cmp    $0x25,%eax
    3a93:	74 18                	je     3aad <printf+0x4d>
  write(fd, &c, 1);
    3a95:	83 ec 04             	sub    $0x4,%esp
    3a98:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3a9b:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3a9e:	6a 01                	push   $0x1
    3aa0:	50                   	push   %eax
    3aa1:	57                   	push   %edi
    3aa2:	e8 4c fe ff ff       	call   38f3 <write>
    3aa7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    3aaa:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3aad:	0f b6 1e             	movzbl (%esi),%ebx
    3ab0:	83 c6 01             	add    $0x1,%esi
    3ab3:	84 db                	test   %bl,%bl
    3ab5:	74 29                	je     3ae0 <printf+0x80>
    c = fmt[i] & 0xff;
    3ab7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3aba:	85 d2                	test   %edx,%edx
    3abc:	74 ca                	je     3a88 <printf+0x28>
      }
    } else if(state == '%'){
    3abe:	83 fa 25             	cmp    $0x25,%edx
    3ac1:	75 ea                	jne    3aad <printf+0x4d>
      if(c == 'd'){
    3ac3:	83 f8 25             	cmp    $0x25,%eax
    3ac6:	0f 84 04 01 00 00    	je     3bd0 <printf+0x170>
    3acc:	83 e8 63             	sub    $0x63,%eax
    3acf:	83 f8 15             	cmp    $0x15,%eax
    3ad2:	77 1c                	ja     3af0 <printf+0x90>
    3ad4:	ff 24 85 08 55 00 00 	jmp    *0x5508(,%eax,4)
    3adb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    3ae6:	5d                   	pop    %ebp
    3ae7:	c3                   	ret
    3ae8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3aef:	00 
  write(fd, &c, 1);
    3af0:	83 ec 04             	sub    $0x4,%esp
    3af3:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3af6:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3afa:	6a 01                	push   $0x1
    3afc:	52                   	push   %edx
    3afd:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3b00:	57                   	push   %edi
    3b01:	e8 ed fd ff ff       	call   38f3 <write>
    3b06:	83 c4 0c             	add    $0xc,%esp
    3b09:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3b0c:	6a 01                	push   $0x1
    3b0e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    3b11:	52                   	push   %edx
    3b12:	57                   	push   %edi
    3b13:	e8 db fd ff ff       	call   38f3 <write>
        putc(fd, c);
    3b18:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b1b:	31 d2                	xor    %edx,%edx
    3b1d:	eb 8e                	jmp    3aad <printf+0x4d>
    3b1f:	90                   	nop
        printint(fd, *ap, 16, 0);
    3b20:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3b23:	83 ec 0c             	sub    $0xc,%esp
    3b26:	b9 10 00 00 00       	mov    $0x10,%ecx
    3b2b:	8b 13                	mov    (%ebx),%edx
    3b2d:	6a 00                	push   $0x0
    3b2f:	89 f8                	mov    %edi,%eax
        ap++;
    3b31:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    3b34:	e8 87 fe ff ff       	call   39c0 <printint>
        ap++;
    3b39:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3b3c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b3f:	31 d2                	xor    %edx,%edx
    3b41:	e9 67 ff ff ff       	jmp    3aad <printf+0x4d>
        s = (char*)*ap;
    3b46:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3b49:	8b 18                	mov    (%eax),%ebx
        ap++;
    3b4b:	83 c0 04             	add    $0x4,%eax
    3b4e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3b51:	85 db                	test   %ebx,%ebx
    3b53:	0f 84 87 00 00 00    	je     3be0 <printf+0x180>
        while(*s != 0){
    3b59:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    3b5c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    3b5e:	84 c0                	test   %al,%al
    3b60:	0f 84 47 ff ff ff    	je     3aad <printf+0x4d>
    3b66:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3b69:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    3b6c:	89 de                	mov    %ebx,%esi
    3b6e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    3b70:	83 ec 04             	sub    $0x4,%esp
    3b73:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
    3b76:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    3b79:	6a 01                	push   $0x1
    3b7b:	53                   	push   %ebx
    3b7c:	57                   	push   %edi
    3b7d:	e8 71 fd ff ff       	call   38f3 <write>
        while(*s != 0){
    3b82:	0f b6 06             	movzbl (%esi),%eax
    3b85:	83 c4 10             	add    $0x10,%esp
    3b88:	84 c0                	test   %al,%al
    3b8a:	75 e4                	jne    3b70 <printf+0x110>
      state = 0;
    3b8c:	8b 75 d4             	mov    -0x2c(%ebp),%esi
    3b8f:	31 d2                	xor    %edx,%edx
    3b91:	e9 17 ff ff ff       	jmp    3aad <printf+0x4d>
        printint(fd, *ap, 10, 1);
    3b96:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3b99:	83 ec 0c             	sub    $0xc,%esp
    3b9c:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3ba1:	8b 13                	mov    (%ebx),%edx
    3ba3:	6a 01                	push   $0x1
    3ba5:	eb 88                	jmp    3b2f <printf+0xcf>
        putc(fd, *ap);
    3ba7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    3baa:	83 ec 04             	sub    $0x4,%esp
    3bad:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    3bb0:	8b 03                	mov    (%ebx),%eax
        ap++;
    3bb2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    3bb5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3bb8:	6a 01                	push   $0x1
    3bba:	52                   	push   %edx
    3bbb:	57                   	push   %edi
    3bbc:	e8 32 fd ff ff       	call   38f3 <write>
        ap++;
    3bc1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3bc4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bc7:	31 d2                	xor    %edx,%edx
    3bc9:	e9 df fe ff ff       	jmp    3aad <printf+0x4d>
    3bce:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    3bd0:	83 ec 04             	sub    $0x4,%esp
    3bd3:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3bd6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3bd9:	6a 01                	push   $0x1
    3bdb:	e9 31 ff ff ff       	jmp    3b11 <printf+0xb1>
    3be0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    3be5:	bb 89 4d 00 00       	mov    $0x4d89,%ebx
    3bea:	e9 77 ff ff ff       	jmp    3b66 <printf+0x106>
    3bef:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bf1:	a1 00 a6 00 00       	mov    0xa600,%eax
{
  ...
  freep = p;
    ...
    3c2f:	5b                   	pop    %ebx
  freep = p;
    3c30:	a3 00 a6 00 00       	mov    %eax,0xa600
}
    3c35:	5e                   	pop    %esi
    3c36:	5f                   	pop    %edi
    3c37:	5d                   	pop    %ebp
    ...
    3c46:	72 ce                	jb     3c16 <free+0x26>
{
  ...
  freep = p;
    3c6a:	a3 00 a6 00 00       	mov    %eax,0xa600
    p->s.size += bp->s.size;
    3c6f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3c72:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3c75:	89 08                	mov    %ecx,(%eax)
}
    3c77:	5b                   	pop    %ebx
    3c78:	5e                   	pop    %esi
    3c79:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c8c:	8b 15 00 a6 00 00    	mov    0xa600,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    3c9d:	0f 84 8d 00 00 00    	je     3d30 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3ca8:	39 f9                	cmp    %edi,%ecx
    3caa:	73 64                	jae    3d10 <malloc+0x90>
  if(nu < 4096)
    3cac:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3cb1:	39 df                	cmp    %ebx,%edi
    3cb3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    3cb6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    3cbd:	eb 0a                	jmp    3cc9 <malloc+0x49>
    3cbf:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3cc0:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3cc2:	8b 48 04             	mov    0x4(%eax),%ecx
    3cc5:	39 f9                	cmp    %edi,%ecx
    3cc7:	73 47                	jae    3d10 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    3ccb:	3b 05 00 a6 00 00    	cmp    0xa600,%eax
    3cd1:	75 ed                	jne    3cc0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    3cd3:	83 ec 0c             	sub    $0xc,%esp
    3cd6:	56                   	push   %esi
    3cd7:	e8 7f fc ff ff       	call   395b <sbrk>
  if(p == (char*)-1)
    3cdc:	83 c4 10             	add    $0x10,%esp
    3cdf:	83 f8 ff             	cmp    $0xffffffff,%eax
    3ce2:	74 1c                	je     3d00 <malloc+0x80>
  hp->s.size = nu;
    3ce4:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3ce7:	83 ec 0c             	sub    $0xc,%esp
    3cea:	83 c0 08             	add    $0x8,%eax
    3ced:	50                   	push   %eax
    3cee:	e8 fd fe ff ff       	call   3bf0 <free>
  return freep;
    3cf3:	8b 15 00 a6 00 00    	mov    0xa600,%edx
      if((p = morecore(nunits)) == 0)
    3cf9:	83 c4 10             	add    $0x10,%esp
    3cfc:	85 d2                	test   %edx,%edx
    3cfe:	75 c0                	jne    3cc0 <malloc+0x40>
        return 0;
  }
}
    3d00:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3d0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3d10:	39 cf                	cmp    %ecx,%edi
    3d12:	74 4c                	je     3d60 <malloc+0xe0>
        p->s.size -= nunits;
    3d14:	29 f9                	sub    %edi,%ecx
    3d16:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3d19:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3d1c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d1f:	89 15 00 a6 00 00    	mov    %edx,0xa600
}
    ...
    3d2f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    3d30:	c7 05 00 a6 00 00 04 	movl   $0xa604,0xa600
    3d37:	a6 00 00 
    base.s.size = 0;
    3d3a:	b8 04 a6 00 00       	mov    $0xa604,%eax
    base.s.ptr = freep = prevp = &base;
    3d3f:	c7 05 04 a6 00 00 04 	movl   $0xa604,0xa604
    3d46:	a6 00 00 
    base.s.size = 0;
    3d49:	c7 05 08 a6 00 00 00 	movl   $0x0,0xa608
    3d50:	00 00 00 
    if(p->s.size >= nunits){
    3d53:	e9 54 ff ff ff       	jmp    3cac <malloc+0x2c>
    3d58:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3d5f:	00 
        prevp->s.ptr = p->s.ptr;
    3d60:	8b 08                	mov    (%eax),%ecx
    3d62:	89 0a                	mov    %ecx,(%edx)
    3d64:	eb b9                	jmp    3d1f <malloc+0x9f>
