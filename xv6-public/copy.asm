...
int main(int argc, char *argv[]) {
  ...
  34:	e8 5a 03 00 00       	call   393 <copy>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	85 c0                	test   %eax,%eax
  3e:	78 13                	js     53 <main+0x53>
  ...
  40:	50                   	push   %eax
  41:	50                   	push   %eax
  42:	68 79 07 00 00       	push   $0x779
  47:	6a 01                	push   $0x1
  49:	e8 f2 03 00 00       	call   440 <printf>
    exit();
  4e:	e8 60 02 00 00       	call   2b3 <exit>
        printf(2, "Copy failed\n");
  53:	52                   	push   %edx
  54:	52                   	push   %edx
  55:	68 6c 07 00 00       	push   $0x76c
  5a:	6a 02                	push   $0x2
  5c:	e8 df 03 00 00       	call   440 <printf>
        exit();
  61:	e8 4d 02 00 00       	call   2b3 <exit>
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 ec 07 00 00 	movzbl 0x7ec(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 94 07 00 00 	jmp    *0x794(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 8a 07 00 00       	mov    $0x78a,%ebx
