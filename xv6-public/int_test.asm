...
_int_test:     file format elf32-i386
...
int main() {
  ...
  11:	68 40 00 00 00       	push   $0x40
  16:	6a 02                	push   $0x2
  18:	e8 3e 03 00 00       	call   35b <signal>
  ...
  23:	68 60 07 00 00       	push   $0x760
  28:	6a 01                	push   $0x1
  2a:	e8 01 04 00 00       	call   430 <printf>
        sleep(100);  // Sleep for a while to avoid spamming output
  2f:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  36:	e8 f8 02 00 00       	call   333 <sleep>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	eb e0                	jmp    20 <main+0x20>

00000040 <sigint_handler>:
void sigint_handler(void) {
  40:	55                   	push   %ebp
  41:	89 e5                	mov    %esp,%ebp
  43:	83 ec 10             	sub    $0x10,%esp
    printf(1, "Caught SIGINT (Shift+C)! Exiting...\n");
  46:	68 38 07 00 00       	push   $0x738
  4b:	6a 01                	push   $0x1
  4d:	e8 de 03 00 00       	call   430 <printf>
    exit();
  52:	e8 4c 02 00 00       	call   2a3 <exit>
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 e8 07 00 00 	movzbl 0x7e8(%edx),%edx
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a4:	ff 24 85 90 07 00 00 	jmp    *0x790(,%eax,4)
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 89 07 00 00       	mov    $0x789,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 a0 0a 00 00       	mov    %eax,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 a0 0a 00 00    	cmp    0xaa0,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
}
 ...
 6ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 a0 0a 00 00 a4 	movl   $0xaa4,0xaa0
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 720:	00 00 00 
    if(p->s.size >= nunits){
