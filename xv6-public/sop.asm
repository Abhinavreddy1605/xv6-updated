 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 1e 07 00 00       	mov    $0x71e,%ebx
...
free(void *ap)
{
 ...
 591:	a1 1c 0a 00 00       	mov    0xa1c,%eax
{
 ...
 5cf:	5b                   	pop    %ebx
  freep = p;
 5d0:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 5d7:	5d                   	pop    %ebp
 ...
 5e6:	72 ce                	jb     5b6 <free+0x26>
{
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60a:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	3b 05 1c 0a 00 00    	cmp    0xa1c,%eax
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
 ...
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 20 0a 00 00       	mov    $0xa20,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 6e6:	0a 00 00 
    base.s.size = 0;
 6e9:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 6f0:	00 00 00 
    if(p->s.size >= nunits){
