...
_server:     file format elf32-i386
...
int main() {
  ...
  16:	6a 01                	push   $0x1
  18:	e8 46 03 00 00       	call   363 <send>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	78 1a                	js     3e <main+0x3e>
        printf(1, "Sender: Failed to send message\n");
    } else {
        printf(1, "Sender: Message sent: %s\n", MSG);
  24:	50                   	push   %eax
  25:	68 38 07 00 00       	push   $0x738
  2a:	68 4d 07 00 00       	push   $0x74d
  2f:	6a 01                	push   $0x1
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 67 07 00 00       	mov    $0x767,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 84 0a 00 00       	mov    %eax,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 84 0a 00 00    	mov    0xa84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 84 0a 00 00    	cmp    0xa84,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 84 0a 00 00    	mov    0xa84,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 88 0a 00 00       	mov    $0xa88,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 720:	00 00 00 
    if(p->s.size >= nunits){
