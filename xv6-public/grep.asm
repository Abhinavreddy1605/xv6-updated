...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	89 cb                	mov    %ecx,%ebx
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
 6d8:	89 d1                	mov    %edx,%ecx
{
 6da:	83 ec 3c             	sub    $0x3c,%esp
 6dd:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
 6e0:	85 d2                	test   %edx,%edx
 6e2:	0f 89 80 00 00 00    	jns    768 <printint+0x98>
 6e8:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
 6ec:	74 7a                	je     768 <printint+0x98>
    x = -xx;
 6ee:	f7 d9                	neg    %ecx
    neg = 1;
 ...
 70b:	0f b6 92 10 0b 00 00 	movzbl 0xb10(%edx),%edx
 712:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
 716:	89 ca                	mov    %ecx,%edx
 718:	89 c1                	mov    %eax,%ecx
 71a:	39 da                	cmp    %ebx,%edx
 71c:	73 e2                	jae    700 <printint+0x30>
  if(neg)
 71e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 721:	85 c0                	test   %eax,%eax
 723:	74 07                	je     72c <printint+0x5c>
    buf[i++] = '-';
 ...
 73e:	88 45 d7             	mov    %al,-0x29(%ebp)
 741:	8d 45 d7             	lea    -0x29(%ebp),%eax
 744:	6a 01                	push   $0x1
 746:	50                   	push   %eax
 747:	56                   	push   %esi
 748:	e8 b6 fe ff ff       	call   603 <write>
  while(--i >= 0)
 74d:	89 f8                	mov    %edi,%eax
 74f:	83 c4 10             	add    $0x10,%esp
 752:	83 ef 01             	sub    $0x1,%edi
 755:	39 c3                	cmp    %eax,%ebx
 757:	75 df                	jne    738 <printint+0x68>
}
 ...
 76a:	eb 89                	jmp    6f5 <printint+0x25>
 ...
 779:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 77c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
 77f:	0f b6 1e             	movzbl (%esi),%ebx
 782:	83 c6 01             	add    $0x1,%esi
 785:	84 db                	test   %bl,%bl
 787:	74 67                	je     7f0 <printf+0x80>
 789:	8d 4d 10             	lea    0x10(%ebp),%ecx
 78c:	31 d2                	xor    %edx,%edx
 78e:	89 4d d0             	mov    %ecx,-0x30(%ebp)
 791:	eb 34                	jmp    7c7 <printf+0x57>
 ...
 7a3:	74 18                	je     7bd <printf+0x4d>
  write(fd, &c, 1);
 7a5:	83 ec 04             	sub    $0x4,%esp
 7a8:	8d 45 e7             	lea    -0x19(%ebp),%eax
 7ab:	88 5d e7             	mov    %bl,-0x19(%ebp)
 7ae:	6a 01                	push   $0x1
 7b0:	50                   	push   %eax
 7b1:	57                   	push   %edi
 7b2:	e8 4c fe ff ff       	call   603 <write>
 7b7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
 7ba:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
 7bd:	0f b6 1e             	movzbl (%esi),%ebx
 7c0:	83 c6 01             	add    $0x1,%esi
 7c3:	84 db                	test   %bl,%bl
 7c5:	74 29                	je     7f0 <printf+0x80>
    c = fmt[i] & 0xff;
 7c7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
 7ca:	85 d2                	test   %edx,%edx
 7cc:	74 ca                	je     798 <printf+0x28>
      }
    } else if(state == '%'){
 7ce:	83 fa 25             	cmp    $0x25,%edx
 7d1:	75 ea                	jne    7bd <printf+0x4d>
      if(c == 'd'){
 7d3:	83 f8 25             	cmp    $0x25,%eax
 7d6:	0f 84 04 01 00 00    	je     8e0 <printf+0x170>
 7dc:	83 e8 63             	sub    $0x63,%eax
 7df:	83 f8 15             	cmp    $0x15,%eax
 7e2:	77 1c                	ja     800 <printf+0x90>
 7e4:	ff 24 85 b8 0a 00 00 	jmp    *0xab8(,%eax,4)
 ...
 819:	88 5d e7             	mov    %bl,-0x19(%ebp)
 81c:	6a 01                	push   $0x1
 81e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
 821:	52                   	push   %edx
 822:	57                   	push   %edi
 823:	e8 db fd ff ff       	call   603 <write>
        putc(fd, c);
 828:	83 c4 10             	add    $0x10,%esp
      state = 0;
 82b:	31 d2                	xor    %edx,%edx
 82d:	eb 8e                	jmp    7bd <printf+0x4d>
 82f:	90                   	nop
        printint(fd, *ap, 16, 0);
 830:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 833:	83 ec 0c             	sub    $0xc,%esp
 836:	b9 10 00 00 00       	mov    $0x10,%ecx
 83b:	8b 13                	mov    (%ebx),%edx
 83d:	6a 00                	push   $0x0
 83f:	89 f8                	mov    %edi,%eax
        ap++;
 841:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
 844:	e8 87 fe ff ff       	call   6d0 <printint>
        ap++;
 849:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 84c:	83 c4 10             	add    $0x10,%esp
      state = 0;
 84f:	31 d2                	xor    %edx,%edx
 851:	e9 67 ff ff ff       	jmp    7bd <printf+0x4d>
        s = (char*)*ap;
 856:	8b 45 d0             	mov    -0x30(%ebp),%eax
 859:	8b 18                	mov    (%eax),%ebx
        ap++;
 85b:	83 c0 04             	add    $0x4,%eax
 85e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
 861:	85 db                	test   %ebx,%ebx
 863:	0f 84 87 00 00 00    	je     8f0 <printf+0x180>
        while(*s != 0){
 869:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
 86c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
 86e:	84 c0                	test   %al,%al
 870:	0f 84 47 ff ff ff    	je     7bd <printf+0x4d>
 876:	8d 55 e7             	lea    -0x19(%ebp),%edx
 879:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 87c:	89 de                	mov    %ebx,%esi
 87e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
 ...
 8a1:	e9 17 ff ff ff       	jmp    7bd <printf+0x4d>
        printint(fd, *ap, 10, 1);
 8a6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 8a9:	83 ec 0c             	sub    $0xc,%esp
 8ac:	b9 0a 00 00 00       	mov    $0xa,%ecx
 8b1:	8b 13                	mov    (%ebx),%edx
 8b3:	6a 01                	push   $0x1
 8b5:	eb 88                	jmp    83f <printf+0xcf>
        putc(fd, *ap);
 8b7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
 8ba:	83 ec 04             	sub    $0x4,%esp
 8bd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
 8c0:	8b 03                	mov    (%ebx),%eax
        ap++;
 8c2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
 8c5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8c8:	6a 01                	push   $0x1
 8ca:	52                   	push   %edx
 8cb:	57                   	push   %edi
 8cc:	e8 32 fd ff ff       	call   603 <write>
        ap++;
 8d1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 8d4:	83 c4 10             	add    $0x10,%esp
      state = 0;
 8d7:	31 d2                	xor    %edx,%edx
 8d9:	e9 df fe ff ff       	jmp    7bd <printf+0x4d>
 ...
 8e9:	6a 01                	push   $0x1
 8eb:	e9 31 ff ff ff       	jmp    821 <printf+0xb1>
 8f0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8f5:	bb ae 0a 00 00       	mov    $0xaae,%ebx
 8fa:	e9 77 ff ff ff       	jmp    876 <printf+0x106>
 8ff:	90                   	nop
 ...
 901:	a1 a0 12 00 00       	mov    0x12a0,%eax
{
 ...
 93f:	5b                   	pop    %ebx
  freep = p;
 940:	a3 a0 12 00 00       	mov    %eax,0x12a0
}
 945:	5e                   	pop    %esi
 946:	5f                   	pop    %edi
 947:	5d                   	pop    %ebp
 ...
 956:	72 ce                	jb     926 <free+0x26>
{
 ...
 977:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 97a:	a3 a0 12 00 00       	mov    %eax,0x12a0
    p->s.size += bp->s.size;
 97f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 982:	8b 4b f8             	mov    -0x8(%ebx),%ecx
...
malloc(uint nbytes)
{
 ...
 9db:	3b 05 a0 12 00 00    	cmp    0x12a0,%eax
 ...
 a68:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 a6f:	00 
        prevp->s.ptr = p->s.ptr;
