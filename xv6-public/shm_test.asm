...
int main() {
   ...
   f:	e8 67 03 00 00       	call   37b <shmget>
    if (!shm) {
  14:	85 c0                	test   %eax,%eax
  16:	74 64                	je     7c <main+0x7c>
  ...
  61:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  64:	e8 6a 02 00 00       	call   2d3 <exit>
        printf(1, "Shared memory released successfully\n");
  69:	52                   	push   %edx
  6a:	52                   	push   %edx
  ...
  7a:	eb e8                	jmp    64 <main+0x64>
        printf(1, "Failed to allocate shared memory\n");
  7c:	50                   	push   %eax
  7d:	50                   	push   %eax
  7e:	68 68 07 00 00       	push   $0x768
  83:	6a 01                	push   $0x1
  85:	e8 d6 03 00 00       	call   460 <printf>
        exit();
  8a:	e8 44 02 00 00       	call   2d3 <exit>
  8f:	90                   	nop
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5e5:	bb 25 08 00 00       	mov    $0x825,%ebx
...
free(void *ap)
{
 ...
 5f1:	a1 24 0b 00 00       	mov    0xb24,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 24 0b 00 00       	mov    %eax,0xb24
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 24 0b 00 00       	mov    %eax,0xb24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 24 0b 00 00    	mov    0xb24,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cb:	3b 05 24 0b 00 00    	cmp    0xb24,%eax
 ...
 6ee:	e8 fd fe ff ff       	call   5f0 <free>
  return freep;
 6f3:	8b 15 24 0b 00 00    	mov    0xb24,%edx
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 71f:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 ...
 72f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 24 0b 00 00 28 	movl   $0xb28,0xb24
 737:	0b 00 00 
    base.s.size = 0;
 73a:	b8 28 0b 00 00       	mov    $0xb28,%eax
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 28 0b 00 00 28 	movl   $0xb28,0xb28
 746:	0b 00 00 
    base.s.size = 0;
 749:	c7 05 2c 0b 00 00 00 	movl   $0x0,0xb2c
 750:	00 00 00 
    if(p->s.size >= nunits){
