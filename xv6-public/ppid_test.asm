...
_ppid_test:     file format elf32-i386
...
int main() {
   ...
   e:	51                   	push   %ecx
    printf(1, "My PID: %d\n", getpid());
   f:	e8 1f 03 00 00       	call   333 <getpid>
  ...
  24:	e8 2a 03 00 00       	call   353 <getppid>
  29:	83 c4 0c             	add    $0xc,%esp
  2c:	50                   	push   %eax
  2d:	68 54 07 00 00       	push   $0x754
  32:	6a 01                	push   $0x1
  34:	e8 07 04 00 00       	call   440 <printf>

    int pid = fork();
  39:	e8 6d 02 00 00       	call   2ab <fork>
    if (pid == 0) {
  3e:	83 c4 10             	add    $0x10,%esp
  41:	85 c0                	test   %eax,%eax
  43:	75 1f                	jne    64 <main+0x64>
        // Child process
        printf(1, "Child PID: %d, Parent PID: %d\n", getpid(), getppid());
  45:	e8 09 03 00 00       	call   353 <getppid>
  4a:	89 c3                	mov    %eax,%ebx
  4c:	e8 e2 02 00 00       	call   333 <getpid>
  51:	53                   	push   %ebx
  52:	50                   	push   %eax
  ...
  5f:	e8 4f 02 00 00       	call   2b3 <exit>
    } else {
        // Parent process
        wait();  // Wait for the child process to finish
  64:	e8 52 02 00 00       	call   2bb <wait>
    }

    exit();  // Exit the parent process
  69:	e8 45 02 00 00       	call   2b3 <exit>
  6e:	66 90                	xchg   %ax,%ax
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 8c 07 00 00 	jmp    *0x78c(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 64 07 00 00       	mov    $0x764,%ebx
 ...
 5d1:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 84 0a 00 00       	mov    %eax,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 84 0a 00 00    	mov    0xa84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 84 0a 00 00    	cmp    0xa84,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 84 0a 00 00    	mov    0xa84,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 84 0a 00 00    	mov    %edx,0xa84
}
 ...
 70f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 84 0a 00 00 88 	movl   $0xa88,0xa84
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 88 0a 00 00       	mov    $0xa88,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 730:	00 00 00 
    if(p->s.size >= nunits){
